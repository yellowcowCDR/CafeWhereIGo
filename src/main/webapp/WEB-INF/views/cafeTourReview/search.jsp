	...
	<head>
		...
		<script>
			function goArticelForm(){ 
				...
				location.href="${contextPath}/cafeTourReview/addArticleForm.do"
				</c:if>
			...
			function onSortingOptionChanged(sortingOptions){
				...
				location.href = "${contextPath}/cafeTourReview/search.do?chapter="+chapter+"&pageNum="+pageNum+"&sortingOption="+sortingOption;
			}
					...
					<div id="tableWrapper">
						<table class="result_table">
							...
							<c:forEach var="article" items="${articleList}">
								<tr>
									...
									<td>
										<a class="article_subject" href="${contextPath}/cafeTourReview/detail.do?article_id=${article.article_id}">[${article.cafe_name}] ${article.article_title}</a>
									</td>
									<td>
						...
						<div class="pagination_wrapper">
							<ul class="pagination pagination-sm">
							    ...
							    <c:if test="${searchCondition.chapter>1}">
							    	<li class="page-item"><a class="page-link" href="${contextPath}/cafeTourReview/search.do?chapter=${searchCondition.chapter-1}&pageNum=5">Previous</a></li>
							    </c:if>
							    <c:forEach begin="1" end="5" step="1" varStatus="status">
							   		<li class="page-item"><a class="page-link" href="${contextPath}/cafeTourReview/search.do?chapter=1&pageNum=${status.index}">${status.index}</a></li>
							    </c:forEach>
							    <li class="page-item"><a class="page-link" href="${contextPath}/cafeTourReview/search.do?chapter=${searchCondition.chapter+1}&pageNum=1">Next</a></li>
							</ul>
						</div>
					</div>
				</div>
