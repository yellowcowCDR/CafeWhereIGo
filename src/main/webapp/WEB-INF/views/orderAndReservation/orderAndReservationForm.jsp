		...
		<section id="mainContainer">
			<div id="mainContentWrapper">
				...
				<div id="formWrapper">
					...
					<form>
						<div id="formContentWrapper">
								...
								<tr>
									...
									<c:forEach var="order" items="${orderList}">
									   ...
									   <tr>
									       ...
									       <td width="70px"><p class="no-top_bottom_margin">${order.goods_price}원</p></td>
									       <td width="45px"><p class="no-top_bottom_margin">수량</p></td>
									       <td>
									           <input class="numberInput" type="number" min=0 value=${order.order_quantity}>
									       </td>
									       <td width="70px"><p class="no-top_bottom_margin">${order.order_quantity * order.goods_price}원</p></td>
									       <td width="28px"><input type="button" class="orderModifyButton" value="변경"></td>
									       <td width="28px"><input type="button" class="orderDeleteButton" value="취소"></td>
							...
							<table align="center" id="reservationTable">
								<tr class="tableHeaderRow">
									<th colspan="7" class="tableHeader"><h4 class="tableTitle no-margin">예약</h4></th>
								</tr>
								<tr>
									<td width="13px"><input class="checkboxInput" type="checkbox"></td>
					...
					<div id="mileageTableContainer" class="align-center">
						<div style="width:908px;" class="align-left">
							<table align="right">
								...
								<tr>
									<td>현재보유점수</td>
									<td><input type="text" id="current_mileage" class="mileageInput" value="2000" readonly>점</td>
								</tr>
								<tr>
									<td>사용가능점수</td>
									<td><input type="text" id="current_available_mileage" class="mileageInput" value="2000" readonly>점</td>
								</tr>
								<tr>
									<td>사용점수</td>
									<td><input type="text" id="mileage_to_use" class="mileageInput" value="0">점</td>
								</tr>
								<tr>
									<td>적립가능금액</td>
									<td><input type="text" id="mileage_to_add" class="mileageInput" value="70" readonly>점</td>
								</tr>
								<tr>
									<td>마일리지적립</td>
									<td><input type="checkbox" id="checkSaveMileage" onchange="onMileageCheckboxChanged(this)"></td>
								</tr>
							</table>
						</div>
					</div>
					...
					<div id="payWrapper">
							<input id="kakaopayButton" type="button" value="카카오페이결제">
							<input id="naverpayButton" type="button" value="네이버페이결제">
					</div>	
				</div>
			</div>
		</section>
