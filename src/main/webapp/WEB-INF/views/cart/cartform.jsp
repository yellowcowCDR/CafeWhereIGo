								...
								<c:forEach var="goodsCart" items="${goodsCartList}">
									...
									<td width="420px">
										<div>
											...
											<forEach var="description" items="${goodsCart.descriptionList}">
												<p class="productDescription no-top_bottom_margin margin-left-10px">${description}</p>
											</forEach>
										</div>
									</td>
									<td width="70px"><p class="no-top_bottom_margin">${goodsCart.price}</p></td>
									<td width="45px"><p class="no-top_bottom_margin">수량</p></td>
									<td>
										<input class="numberInput" type="number" min=0 value=${goodsCart.quantity}>
									</td>
									<td width="70px"><p class="no-top_bottom_margin">3500원</p></td>
									<td width="28px"><input type="button" class="orderModifyButton" value="변경"></td>
									<td width="28px"><input type="button" class="orderDeleteButton" value="취소"></td>
