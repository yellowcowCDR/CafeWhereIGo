...
<html>
	<head>
		...
		<script type="text/javascript" charset="utf-8" src="${contextPath}/resources/js/getGeometricInfo.js"></script>
							...
							<table>
								...
								<tr id="formRow3">
									...
									<td>
										...
										<input type="text" id="searchKeword" value="${cafeSearchParameter.searchKeyword}">
									</td>
								</tr>
								<tr id="formRow4">
								<td></td>
								<td></td>
									<td style="text-align:end">
										<input type="button" id="submitButton" onclick="searchCafe('${contextPath}')" value='검색'>
									</td>
								</tr>
							</table>
						</form>
