...
<script type="text/javascript" src="${contextPath}/resources/js/commons/starRatings.js"></script>
<style>
	#mainContainer{
		display:flex;
          					...
          					<tr>
          						<td>
          							<div style="display:flex; justify-content: flex-start; align-items:center;">
	          							...
	          							<input type="hidden" value='${orderHistoryMapList.size()}'>
	          							<select name="orderHistory">
	          								<c:if test="${orderHistoryMapList != null}">
