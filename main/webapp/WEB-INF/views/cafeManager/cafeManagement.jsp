						...
						<div id="formContentWrapper">
							...
							<table align="center" id="orderTable">
								...
								<tr>
									...
									<td width="380px">
										<div>
											<a href="${contextPath}/cafe/cafe_detail.do" class="no-text-decoration link-text-always-black"><h3 class="productName no-top_bottom_margin margin-left-10px">카페 블루</h3></a>
									...
									<td>
										<div style="display:flex;" class="margin-left-10px">
												<img class="theme_score_icon" src="${contextPath}/resources/image/parking_icon.svg"><p class="no-top_bottom_margin">70</p>
												<img class="theme_score_icon" src="${contextPath}/resources/image/socket_icon.svg"><p class="no-top_bottom_margin">70</p>
												<img class="theme_score_icon" src="${contextPath}/resources/image/wifi_icon.svg"><p class="no-top_bottom_margin">70</p>
												<img class="theme_score_icon" src="${contextPath}/resources/image/socket_icon.svg"><p class="no-top_bottom_margin">70</p>
												<img class="theme_score_icon" src="${contextPath}/resources/image/wifi_icon.svg"><p class="no-top_bottom_margin">70</p>
										</div>
									</td>
									<td width="28px"><a href="${contextPath}/cafeManager/modifyCafeForm.do"><input type="button" class="orderModifyButton" value="변경"></a></td>
									<td width="28px"><input type="button" class="orderDeleteButton" value="삭제"></td>
