							...
							<div class="input_container">
								<div class="input_container_inner">
									<table id="userinfo_input_table">
										...
										<tr>
											<td>
												<input type="text" id="user_id" class="input_box" disabled>
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
												<input type="email" id="user_email" class="input_box">
											</td>
										</tr>
										<tr>
											<td>
										...
										<tr>
											<td>
												<input type="text" id="bussiness_number_forView" class="input_box" value="000-00-00000">
											</td>
										</tr>
										<tr>
											<td>
