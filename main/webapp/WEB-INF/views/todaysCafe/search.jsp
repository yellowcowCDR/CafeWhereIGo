			...
			<div id="mainContentWrapper">
				...
				<div>
					<div id="top_menu">
						...
						<a href="${contextPath}/todaysCafe/addArticleForm.do"><button id="add_article_button">글쓰기</button></a>
					</div>
					<div id="tableWrapper">
						<table class="result_table">
							...
							<tr>
								...
								<td>
									<a class="article_subject" href="${contextPath}/todaysCafe/detail.do">[카페 광안] 시원한 광안리뷰를 자랑하는 카페</a>
								</td>
								<td>
									<p>관리자</p>
								</td>
