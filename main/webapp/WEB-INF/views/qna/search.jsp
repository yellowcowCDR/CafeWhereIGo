	...
	<head>
		...
		<script>
			function goArticelForm(){ 
				...
				location.href="${contextPath}/qna/addArticleForm.do"
				</c:if>
						...
						<table class="result_table">
							...
							<c:forEach var="article" items="${articleList}">
								<tr>
									...
									<td>
										<a class="article_subject" href="${contextPath}/qna/detail.do?article_id=${article.article_id}">[${article.cafe_name}] ${article.article_title}</a>
									</td>
									<td>
